 ...
 */
class getEmployeeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmployeeRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/EmployeeRepository.php';

        return $container->privates['App\\Repository\\EmployeeRepository'] = new \App\Repository\EmployeeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
